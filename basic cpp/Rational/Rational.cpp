...
void Rational::print(std::ostream& a_os) const
{
	a_os << "Rational number="
			<<m_numer
			<<"/"
			<<m_denom;
}
...
void Rational::mul(Rational const& a_other)
{
...
void Rational::div(Rational const& a_other)
{
...
void Rational::add(Rational const& a_other)
{
...
void Rational::sub(Rational const& a_other)
{
